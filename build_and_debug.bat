...
rmdir /Q /S build
rmdir /Q /S dist
python39 -m PyInstaller __init__.py --icon icon.ico --add-data "icon.ico;." --add-data "resources;resources" --add-data "lang;lang" --debug all --clean --version-file ../elevenclock-version-info
