...
class SettingsWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.transparentclickEventFS.setChecked(getSettings("MouseEventTransparentFS"))
        self.transparentclickEventFS.stateChanged.connect(lambda i: setSettings("MouseEventTransparentFS", bool(i)))
    ...
    {_("Now you should see the clock everywhere")}""")
        ...
        self.disableLang.setChecked(getSettings("DisableLangAutoUpdater"))
        self.disableLang.stateChanged.connect(lambda i: setSettings("DisableLangAutoUpdater", bool(i)))
