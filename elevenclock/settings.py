...
class SettingsWindow(QFramelessWindow):
    def __init__(self):
        ...
        self.primaryScreen = QSettingsCheckBoxWithWarning(_("Show the clock on the primary screen"), _("You might need to set a custom background color for this to work.&nbsp;More info <a href=\"{0}\" style=\"color:DodgerBlue\">HERE</a>").format("https://github.com/martinet101/ElevenClock/discussions/333#discussioncomment-1726960"))
