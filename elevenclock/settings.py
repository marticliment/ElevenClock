...
class SettingsWindow(QMainWindow):
    ...
    {_("Now you should see the clock everywhere")}""")
        ...
        self.legacyFullScreenHide.setStyleSheet(f"QWidget#stChkBg{{border-bottom-left-radius: {self.getPx(8)}px;border-bottom-right-radius: {self.getPx(8)}px;border-bottom: {self.getPx(1)}px;}}")
