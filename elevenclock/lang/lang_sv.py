...
lang_3_5_0 = {
    ...
    "Disable tooltip's blurry background": "Inaktivera suddig bakgrund på verktygstips",
    "Sync time with the internet": "Synka tid med internet",
    "Internet date and time": "Internet datum och tid",
    "Select internet time provider, change sync frequency": "Välj tidsleverantör från internet, ändra synkfrekvensen",
    "Enable internet time sync": "Aktivera tidssynk från internet",
    "Paste a URL from the world clock api or equivalent": "Klistra in en URL från world clock api eller liknande",
    "Help": "Hjälp",
    "Internet sync frequency": "Synkfrekvens ",
