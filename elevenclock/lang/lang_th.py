...
lang_3_5_0 = {
    "Tooltip Appearance:": "ลักษณะคำแนะนำเครื่องมือ:",
    "Tooltip's font, font size, font color and background": "ฟอนต์ของคำแนะนำเครื่องมือ, ขนาดฟอนต์, สีฟอนต์และพื้นหลัง",
    "Disable tooltip's blurry background": "ปิดใช้งานพื้นหลังเบลอของคำแนะนำเครื่องมือ",
    "Sync time with the internet": "ซิงค์เวลากับอินเทอร์เน็ต",
    "Internet date and time": "วันที่และเวลาอินเทอร์เน็ต",
    "Select internet time provider, change sync frequency": "เลือกผู้ให้บริการเวลาอินเทอร์เน็ต, เปลี่ยนความถี่ในการซิงค์",
    "Enable internet time sync": "เปิดใช้งานการซิงค์เวลาอินเทอร์เน็ต",
    "Paste a URL from the world clock api or equivalent": "วาง URL จาก API นาฬิกาโลกหรือเทียบเท่า",
    "Help": "ช่วยเหลือ",
    "Internet sync frequency": "ความถี่ในการซิงค์กับอินเทอร์เน็ต",
    "10 minutes": "10 นาที",
    "30 minutes": "30 นาที",
    "1 hour": "1 ชั่วโมง",
    "2 hours": "2 ชั่วโมง",
