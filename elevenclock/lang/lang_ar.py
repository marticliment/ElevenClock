...
lang_2_9 = lang_2_9_2 | {
    ...
    "Hide extended options from the clock right-click menu (needs a restart to be applied)": "إخفاء الخيارات الموسعة من قائمة النقر بزر الماوس الأيمن (يحتاج إلى إعادة تشغيل ليتم تطبيقها)",
